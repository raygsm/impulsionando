      ...
      <div className="grid min-h-dvh lg:grid-cols-2">
        ...
        <aside className="relative hidden overflow-hidden lg:block">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-12">
            <Link to="/colors" className="inline-flex items-center gap-2">
              <ColorsMark size={40} />
              <span className="text-xl font-black tracking-tight">Colors Saúde</span>
            </Link>
            ...
            <div>
              ...
              <h2 className="mt-4 max-w-md text-4xl font-black leading-tight">
                ...
                <span className="text-emerald-300">num só lugar.</span>
              </h2>
              ...
              <ul className="mt-6 grid max-w-md gap-2 text-sm text-white/90">
            ...
            <p className="text-xs text-white/70">© Colors Saúde — Grupo Impulsionando</p>
          </div>
        </aside>
        ...
        <main className="flex flex-col">
          <div className="border-b border-white/10 px-6 py-4 lg:hidden">
            <Link to="/colors" className="inline-flex items-center gap-2 text-sm text-white/85 hover:text-white">
