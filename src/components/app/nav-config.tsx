import {
  ...
  Beer, Store, Send, Ticket, Utensils, Coffee, Wine,
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { to: "/cervejaria", label: "Microcervejaria — Painel", icon: Beer },
          { to: "/cervejaria/pdvs", label: "Microcervejaria — PDVs Parceiros", icon: Store },
          { to: "/cervejaria/catalogo", label: "Microcervejaria — Catálogo", icon: Megaphone },
          { to: "/cervejaria/relacionamento", label: "Microcervejaria — Relacionamento", icon: Users },
          { to: "/cervejaria/retorno", label: "Microcervejaria — Retorno PDV", icon: BarChart3 },
          { to: "/cervejaria/marketplace", label: "Microcervejaria — Marketplace B2B", icon: Handshake },
