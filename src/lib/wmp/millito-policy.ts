...
export const MILLITO_CLOSING_FLOW = {
  ...
  closingMessage: 'Pois não. Caso queira, você pode receber por e-mail uma cópia completa desta conversa com o protocolo do atendimento.',
  protocolRequired: true,
  exportRequiresWmpRegistration: true,
  exportRequiredFields: ['full_name', 'email', 'mobile'] as const,
  exportOptionalFields: ['cpf', 'cnpj', 'company', 'cep', 'address', 'segment', 'role', 'source'] as const,
  maxRegistrationQuestions: 10,
