export const MILITO_STAGES = ['QUALIFY','VENUE','MEDIA','TECHNICAL','SETUP','PROPOSAL','CLOSE'] as const
export type MilitoStage = typeof MILITO_STAGES[number]

export const MILITO_REQUIRED_FACTS = [
...
export const MILITO_MEDIA_RULES = {
...
export const MILITO_HANDOFF_REASONS = [
...
export const MILITO_AUTONOMOUS_ACTIONS = [
