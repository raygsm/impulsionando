...
async function resolveCompanyId(supabase: any, userId: string): Promise<string> {
  // Sempre resolve o tenant RioMed via core_tenant_identity (caller pode ser
  // master Impulsionando, cujo user_profiles.company_id NÃO é a RioMed).
  ...
  // Fallback: caller é membro direto da empresa.
