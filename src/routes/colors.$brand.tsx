  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#08110d] px-6 text-white">
      <section className="max-w-xl rounded-3xl border border-emerald-400/20 bg-white/[0.04] p-8 text-center shadow-2xl">
        <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-emerald-400 text-2xl font-black text-black">C</div>
        <h1 className="mt-5 text-3xl font-black">Uma só Colors Saúde.</h1>
        <p className="mt-3 text-white/70">As antigas divisões de linha deixaram de organizar a experiência pública. Todo o portfólio, suporte, agenda, eventos e canais oficiais agora estão reunidos na Colors.</p>
