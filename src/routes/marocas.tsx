...
export const Route = createFileRoute("/marocas")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Marocas — gestão de locação por temporada" },
      { name: "twitter:description", content: "Operação profissional do seu imóvel de temporada, sem dor de cabeça." },
    ],
