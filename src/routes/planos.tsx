...
function buildPlans(wage: number): Plan[] {
  return [
    {
      name: "Essencial",
      tagline: "Para quem está começando — resolva o ponto mais crítico da operação, sem pagar pelo que não usa.",
      monthly: wage / 2,
      modulesLabel: "Até 3 módulos + base operacional",
      features: [
        "Ideal para: profissionais autônomos, MEI e times de até 3 pessoas dando o primeiro salto digital",
        "Principal benefício: 1ª venda em 48h com o módulo que mais dói (CRM, Agenda, PDV, EHR, Vitrine ou Eventos)",
        "Base inclusa: dashboard, cadastros, perfis e permissões, auditoria",
        "Financeiro essencial (contas a receber + fluxo de caixa)",
        "Até 3 usuários · 1 unidade · suporte por e-mail",
        "7 dias de Trial com tudo liberado, sem cartão",
        "Próximo passo: contratar em minutos com Pix",
      ],
    ...
    },
    {
      name: "Integrado",
      displayName: "Ideal",
      tagline: "Plano mais escolhido — dois módulos que se conversam e trabalham juntos no automático.",
      monthly: wage,
      modulesLabel: "Até 6 módulos integrados + automação",
      features: [
        "Ideal para: negócios com equipe estruturada que já perdem tempo com planilhas e sistemas soltos",
        "Principal benefício: ROI mensurável em 30 dias com automações cruzadas entre módulos",
        "Até 6 módulos em pares curados (CRM + Agenda, PDV + Estoque, Vitrine + CRM Imobiliário, EHR + Agenda Clínica)",
        "Financeiro completo, central de mensagens e mais dashboards",
        "Até 5 usuários · 1 unidade · API e webhooks · suporte prioritário",
        "Próximo passo: escolher os módulos e começar em minutos",
      ],
      highlight: true,
      cta: "Assinar o Ideal",
    },
    {
      name: "Avançado",
      displayName: "Full",
      tagline: "Para operações que exigem escala — multiunidade, IA avançada e customizações sob medida.",
      monthly: wage * 2, // 2 SM
      modulesLabel: "Módulos ilimitados + BI consolidado + IA avançada",
      features: [
        "Ideal para: redes, franquias e empresas com mais de uma unidade ou processos exclusivos",
        "Principal benefício: rollout completo em 30–60 dias com CSM dedicado",
        "Módulos ilimitados + multi-unidade sem teto prático + gestão por setores",
        "Customizações sob medida, integrações dedicadas e White Label parcial",
        "IA avançada (atendimento, recomendação, copilots internos) e governança LGPD expandida",
        "Suporte prioritário com acompanhamento técnico dedicado",
        "Próximo passo: solicitar proposta com nosso time",
      ],
      cta: "Solicitar proposta Full",
    },
  ];
}
