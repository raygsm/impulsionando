      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        <div className="rounded-2xl border bg-white p-8 text-center shadow-sm">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <Link to="/riomed/cotizar" className="rounded-full px-5 py-2.5 text-white font-semibold" style={{ background: "var(--riomed-primary, #0B3D74)" }}>Solicitar cotización</Link>
          </div>
        </div>
      </div>
    );
