  ...
  return <ChrismedShell><main className="min-h-[70vh] bg-[var(--chrismed-ivory)] px-5 py-16 text-[var(--chrismed-forest-deep)] sm:px-6 md:py-24">
    <section className="mx-auto max-w-3xl overflow-hidden rounded-[2rem] border border-[var(--chrismed-sand)] bg-white shadow-[var(--chrismed-shadow-md)]">
      ...
      <div className="p-7 md:p-10">
        ...
        {mutation.error && <><Message title="Não foi possível confirmar automaticamente" text="O convite pode estar expirado ou temporariamente indisponível. Tente novamente ou fale com a equipe CHRISMED." /><button type="button" onClick={() => mutation.mutate()} disabled={mutation.isPending} className="chrismed-cta mt-5 inline-flex min-h-12 items-center justify-center rounded-full px-7 py-3 text-sm font-bold">Tentar confirmar novamente</button></>}
