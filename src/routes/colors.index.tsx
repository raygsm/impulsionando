...
export const Route = createFileRoute("/colors/")({
  head: () => ({
    meta: [
      { title: "Color Saúde — Produtos oficiais, Íris, suporte, afiliados e eventos" },
      { name: "description", content: "Color Saúde: produtos oficiais, Super Green Black, atendimento inteligente com a Íris, suporte com protocolo, agenda, afiliados, eventos e rastreabilidade de jornada." },
      { name: "keywords", content: "Color Saúde, Super Green Black, produtos Color Saúde, afiliados Color Saúde, eventos Color Saúde, atendimento Color Saúde, Íris" },
      { property: "og:title", content: "Color Saúde — Uma marca. Uma jornada. Íris com você." },
      { property: "og:description", content: "Conheça os produtos oficiais da Color Saúde, fale com a Íris, agende uma conversa, participe de eventos e acesse suporte com protocolo." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: `${COLORS_PUBLIC_ORIGIN}/` },
      { property: "og:site_name", content: "Color Saúde" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Color Saúde" },
    ...
    scripts: [{ type: "application/ld+json", children: JSON.stringify({
      "@context":"https://schema.org", "@type":"Organization", name:"Color Saúde", url:`${COLORS_PUBLIC_ORIGIN}/`,
      description:"Ecossistema comercial e de relacionamento da Color Saúde.",
