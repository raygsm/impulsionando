        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              ...
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/clientes">Clientes 360°</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
              ...
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/equipe">Equipe</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/relatorios-avancados">BI avançado</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/atendimento">Atendimento</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/fidelidade">Fidelidade</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
              ...
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/multi-unidades">Multi-unidades</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/franquias">Franquias</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/parceiros">Parceiros</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/onboarding">Onboarding</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/cases">Casos de sucesso</Link>
              </Button>

              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/precificacao">Precificação & ROI</Link>
              </Button>

              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/marketplace-apps">Marketplace Apps</Link>
              </Button>

              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/mobile">Apps mobile</Link>
              </Button>

              <Button asChild size="lg" variant="outline">
                <Link to="/showroom/api-publica">API pública</Link>
              </Button>
