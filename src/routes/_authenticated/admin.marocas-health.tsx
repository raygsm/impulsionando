  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm">Apartamentos</CardTitle></CardHeader><CardContent><div className="text-2xl font-bold">{fmt(data.apartments.active)}<span className="text-sm text-muted-foreground">/{fmt(data.apartments.total)}</span></div></CardContent></Card>
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm">Extratos Proprietários</CardTitle></CardHeader><CardContent><div className="text-2xl font-bold">{brl(data.statements.amount)}</div><p className="text-xs text-muted-foreground">{fmt(data.statements.sent)}/{fmt(data.statements.total)} enviados</p></CardContent></Card>
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm">Suprimentos</CardTitle></CardHeader><CardContent><div className="text-2xl font-bold">{brl(data.supplies.amount)}</div><p className="text-xs text-muted-foreground">{fmt(data.supplies.total)} pedidos</p></CardContent></Card>
