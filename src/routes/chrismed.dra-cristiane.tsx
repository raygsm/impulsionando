...
export const Route = createFileRoute('/chrismed/dra-cristiane')({
  head: () => ({
    meta: [
      ...
      { property: 'og:url', content: 'https://chrismed.impulsionando.com.br/chrismed/dra-cristiane' },
      { property: 'og:site_name', content: 'CrisMed' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: 'Dra. Cristiane Alencar — CrisMed' },
      { name: 'twitter:description', content: 'Medicina privada, internacional e humana.' },
    ],
    links: [{ rel: 'canonical', href: 'https://chrismed.impulsionando.com.br/chrismed/dra-cristiane' }],
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        medicalSpecialty: ['GeneralPractice', 'Geriatric', 'InternalMedicine'],
        areaServed: ['Rio de Janeiro', 'Internacional'],
        availableService: ['Teleconsulta', 'Atendimento domiciliar', 'Consultório em Copacabana'],
