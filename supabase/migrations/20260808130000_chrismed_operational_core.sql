...
-- This migration is intentionally re-runnable on top of older CHRISMED schema
-- snapshots. Recreate only the policies owned by this migration so their
-- canonical definitions below win without weakening RLS or relying on
-- non-idempotent CREATE POLICY statements.
